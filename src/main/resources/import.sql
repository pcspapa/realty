...
insert into client(id, company, mobile, name) values(1, 'google', '010-1234-5678', '구글');
insert into client(id, company, mobile, name) values(2, 'facebook', '010-2345-6789', '페이스북');
insert into client(id, company, mobile, name) values(3, 'twitter', '010-3456-7890', '트위터');
insert into client(id, company, mobile, name) values(4, 'daum', '010-4567-8901', '다음');
